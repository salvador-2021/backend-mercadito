...
var controller = {
    ...
    saveData: (req, res) => {
        ...
        var datos_producto = {
            ...
            material_relleno: body.material_relleno,
            tipo_colchon: body.tipo_colchon,
            altura: body.altura,
            ancho: body.ancho,
            grosor: body.grosor,
            marca: body.marca,
        ...
        Negocio.find({ _id: _idNegocio }).
            ...
            exec((err, listProducto) => {
                ...
                listProducto.forEach((productos, index, data) => {
                    ...
                    productos['cama'].forEach((producto, index, data) => {
    ...
    getAllProducto: (req, res) => {
        ...
        Negocio.find().
            and([{ estado: true }, { "cama.estado": true }]).
            select({ cama: 1, _id: 1 }).
            sort({ "cama.precio": 1 }).
            exec((err, listProducto) => {
    ...
    searchproductId: (req, res) => {
        ...
        if (req.params._id) { //BUSQUEDAD POR ID
            ...
            Negocio.findOne({ "cama._id": req.params._id }, { "cama.$": 1 }).exec((err, listProducto) => {
    ...
    searchproductName: (req, res) => {
        ...
        queryMongo.
            ...
            exec((err, camas) => {
                ...
                camas.forEach((cama, index, data) => {

                    cama['cama'].forEach((producto, index, data) => {
    ...
    countProductNegocio: (req, res) => {
        ...
        queryMongo.
            ...
            exec((err, camas) => {
                ...
                if (camas[0].cama.length == 0 || camas[0].cama.length == null) {
                    return res.status(200).send({
                        status: "success",
                        message: 0
                    });
    ...
    getImage: (req, res) => {
        ...
        var path_file = './uploads/' + _idNegocio + '/cama/' + nameImage;
    ...
    deleteAllImageProduct: (req, res) => {
        ...
        const _idnegocio = req.negocio_autentificado._id;
        const rutaArchivoEliminar = '../../uploads/' + _idnegocio + '/cama';
    ...
    actualizarImage: (req, res) => {
        ...
        if (file_ext != 'png' && file_ext != 'jpg' && file_ext != 'jpeg') {
            //BORRAR EL ARCHIVO SUBIDO
            let rutaArchivoEliminar = './uploads/' + _idNegocio + '/cama/' + file_name;
            ...
            Negocio.findOne(
                { "_id": _idNegocio },
                { "cama._id": _idProducto },
                { 'cama.imagen._id': _idImage }).
                select({ 'cama.imagen': 1 }).
                exec((err, resultquery) => {
                    ...
                    if (resultquery) {
                        ...
                        resultquery["cama"].forEach((lista_image, index, data) => {
                            ...
                            lista_image["imagen"].forEach((datos, index, data) => {
                                ...
                                if (datos['_id'] == _idImage) {
                                    ...
                                    var rutaArchivo = './uploads/' + _idNegocio + '/cama/' + datos['ruta'];
...
async function actualizarImagen(_idNegocio, _idProducto, _id_image, rutaImage) {
    let productUpdate = await Negocio.updateOne(
        { "_id": { $eq: _idNegocio } },
        { $set: { "cama.$[prod].imagen.$[img].ruta": rutaImage } },
        {
            arrayFilters: [
