...
var controller = {
    ...
    saveData: (req, res) => {
        ...
        var datos_producto = {
            ...
            potencia_max: body.potencia_max,
            torque_max: body.torque_max,
            peso_maxCarga: body.peso_maxCarga,
            peso_moto: body.peso_moto,
            refrigeracion: body.refrigeracion,
            bateria: body.bateria,
            suspen_Trasera: body.suspen_Trasera,
            suspen_delantera: body.suspen_delantera,
            llanta_trasera: body.llanta_trasera,
            llanta_delantera: body.llanta_delantera,
            ancho: body.ancho,
            altura: body.altura,
            anio_modelo: body.anio_modelo,
            capacidad_tanque: body.capacidad_tanque,
        ...
        Negocio.find({ _id: _idNegocio }).
            ...
            exec((err, listProducto) => {
                ...
                listProducto.forEach((productos, index, data) => {
                    ...
                    productos['moto'].forEach((producto, index, data) => {
    ...
    getAllProducto: (req, res) => {
        ...
        Negocio.find().
            and([{ estado: true }, { "moto.estado": true }]).
            select({ moto: 1, _id: 1 }).
            sort({ "moto.precio": 1 }).
            exec((err, listProducto) => {
    ...
    searchproductId: (req, res) => {
        if (req.params._id) { //BUSQUEDAD POR ID
            ...
            Negocio.findOne({ "moto._id": req.params._id }, { "moto.$": 1 }).exec((err, listProducto) => {
    ...
    searchproductName: (req, res) => {
        ...
        queryMongo = Negocio.find({
            ...
            "$or": [
                ...
                { "moto.descripcion": { "$regex": nombrebody, "$options": "i" } }
            ]
        });
        ...
        queryMongo.
            ...
            exec((err, motos) => {
                ...
                motos.forEach((moto, index, data) => {

                    moto['moto'].forEach((producto, index, data) => {
    ...
    countProductNegocio: (req, res) => {
        ...
        queryMongo.
            ...
            exec((err, motos) => {
                ...
                if (motos[0].moto.length == 0 || motos[0].moto.length == null) {
                    return res.status(200).send({
                        status: "success",
                        message: 0
                    });
    ...
    actualizarImage: (req, res) => {
        ...
        if (file_ext != 'png' && file_ext != 'jpg' && file_ext != 'jpeg') {
            ...
            let rutaArchivoEliminar = './uploads/' + _idNegocio + '/moto/' + file_name;
            ...
            Negocio.findOne(
                { "_id": _idNegocio },
                { "moto._id": _idProducto },
                { 'moto.imagen._id': _idImage }).
                select({ 'moto.imagen': 1 }).
                exec((err, resultquery) => {
                    ...
                    if (resultquery) {
                        ...
                        resultquery["moto"].forEach((lista_image, index, data) => {
                            ...
                            lista_image["imagen"].forEach((datos, index, data) => {
                                ...
                                if (datos['_id'] == _idImage) {
                                    ...
                                    var rutaArchivo = './uploads/' + _idNegocio + '/moto/' + datos['ruta'];
    ...
    getImage: (req, res) => {
        ...
        var path_file = './uploads/' + _idNegocio + '/moto/' + nameImage;
    ...
    deleteImageProduct: (req, res) => {
        ...
        const rutaArchivoEliminar = './uploads/' + _idNegocio + '/moto/' + _nameImage;
    ...
    deleteAllImageProduct: (req, res) => {
        ...
        const _idnegocio = req.negocio_autentificado._id;
        const rutaArchivoEliminar = '../../uploads/' + _idnegocio + '/moto';
...
async function actualizarImagen(_idNegocio, _idProducto, _id_image, rutaImage) {
    let productUpdate = await Negocio.updateOne(
        { "_id": { $eq: _idNegocio } },
        { $set: { "moto.$[prod].imagen.$[img].ruta": rutaImage } },
        {
            arrayFilters: [
