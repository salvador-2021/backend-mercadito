...
var controller = {
    ...
    saveData: (req, res) => {
        ...
        var datos_producto = {
            ...
            velocidades: body.velocidades,
            marca: body.marca,
            material: body.material,
            frenos: body.frenos,
            pedales: body.pedales,
            pesoProducto: body.pesoProducto,
            pesoSoportado: body.pesoSoportado,
            genero: body.genero,
            color: body.color,
        ...
        Negocio.find({ _id: _idNegocio }).
            ...
            exec((err, listProducto) => {
                ...
                listProducto.forEach((productos, index, data) => {
                    ...
                    productos['bicicleta'].forEach((producto, index, data) => {
    ...
    getAllProducto: (req, res) => {
        ...
        Negocio.find().
            and([{ estado: true }, { "bicicleta.estado": true }]).
            select({ bicicleta: 1, _id: 1 }).
            sort({ "bicicleta.precio": 1 }).
            exec((err, listProducto) => {
    ...
    searchproductId: (req, res) => {
        ...
        if (req.params._id) { //BUSQUEDAD POR ID
            ...
            Negocio.findOne({ "bicicleta._id": req.params._id }, { "bicicleta.$": 1 }).exec((err, listProducto) => {
    ...
    searchproductName: (req, res) => {
        ...
        queryMongo.
            ...
            exec((err, bicicletas) => {
                ...
                bicicletas.forEach((bicicleta, index, data) => {

                    bicicleta['bicicleta'].forEach((producto, index, data) => {
    ...
    countProductNegocio: (req, res) => {
        ...
        queryMongo.
            ...
            exec((err, bicicletas) => {
                ...
                if (bicicletas[0].bicicleta.length == 0 || bicicletas[0].bicicleta.length == null) {
                    return res.status(200).send({
                        status: "success",
                        message: 0
                    });
                ...
                return res.status(200).send({
                    status: "success",
                    message: bicicletas[0].bicicleta.length
                });
    ...
    getImage: (req, res) => {
        ...
        var path_file = './uploads/' + _idNegocio + '/bicicleta/' + nameImage;
    ...
    deleteImageProduct: (req, res) => {
        ...
        const rutaArchivoEliminar = './uploads/' + _idNegocio + '/bicicleta/' + _nameImage;
    ...
    deleteAllImageProduct: (req, res) => {
        ...
        const _idnegocio = req.negocio_autentificado._id;
        const rutaArchivoEliminar = '../../uploads/' + _idnegocio + '/bicicleta';
    ...
    actualizarImage: (req, res) => {
        ...
        if (file_ext != 'png' && file_ext != 'jpg' && file_ext != 'jpeg') {
            //BORRAR EL ARCHIVO SUBIDO
            let rutaArchivoEliminar = './uploads/' + _idNegocio + '/bicicleta/' + file_name;
            ...
            Negocio.findOne(
                { "_id": _idNegocio },
                { "bicicleta._id": _idProducto },
                { 'bicicleta.imagen._id': _idImage }).
                select({ 'bicicleta.imagen': 1 }).
                exec((err, resultquery) => {
                    ...
                    if (resultquery) {
                        ...
                        resultquery["bicicleta"].forEach((lista_image, index, data) => {
                            ...
                            lista_image["imagen"].forEach((datos, index, data) => {
                                ...
                                if (datos['_id'] == _idImage) {
                                    ...
                                    var rutaArchivo = './uploads/' + _idNegocio + '/bicicleta/' + datos['ruta'];
...
async function agregarImagen(_idNegocio, _idProducto, rutaImage) {
    ...
    let productUpdate = await Negocio.updateOne({
        ...
        "$push":
            { "bicicleta.$.imagen": { "ruta": rutaImage } }
    });
...
async function actualizarImagen(_idNegocio, _idProducto, _id_image, rutaImage) {
    let productUpdate = await Negocio.updateOne(
        { "_id": { $eq: _idNegocio } },
        { $set: { "bicicleta.$[prod].imagen.$[img].ruta": rutaImage } },
        {
            arrayFilters: [
